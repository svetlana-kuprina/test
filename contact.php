...
<form action="check_contact.php" method="post">
    ...
    <input type="email" name="subject" value="<?=$_SESSION['subject']?>" placeholder="Тема сообщения" class="form-control"> <br>
    <textarea name="message" placeholder ="Ваше собщение" class="form-control"><?=$_SESSION['message']?> </textarea><br>
